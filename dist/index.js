...
var S=require('@stdlib/ndarray-base-assert-is-row-major/dist'),T=require('@stdlib/math-base-special-fast-max/dist'),z=require('@stdlib/math-base-special-fast-min/dist');function C(n,e,t,f,m,u,d,i,s,l,q){var v,o,r,a;if(v=d,o=q,S([m,u])){for(a=0;a<n;a++){for(r=0;r<=z(a+t,e-1);r++)i[o+r*s]=f[v+r*u];v+=m,o+=l}return i}for(a=0;a<e;a++){for(r=T(0,a-t);r<n;r++)i[o+r*l]=f[v+r*m];v+=u,o+=s}return i}w.exports=C
});var R=g(function(M,y){
var G=require('@stdlib/blas-base-layout-resolve-str/dist'),H=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),p=require('@stdlib/math-base-special-fast-max/dist'),c=require('@stdlib/error-tools-fmtprodmsg/dist'),I=b();function J(n,e,t,f,m,u,d,i){var s,l,q,v,o,r,a,x;if(x=G(n),x===null)throw new TypeError(c('36XFx',n));if(s=H(x),s?(r=t,a=e):(r=e,a=t),u<p(1,r))throw new RangeError(c('36XJL',r,u));if(i<p(1,a))throw new RangeError(c('36XGM',a,i));return s?(l=u,q=1,v=i,o=1):(l=1,q=u,v=1,o=i),I(e,t,f,m,l,q,0,d,v,o,0)}y.exports=J

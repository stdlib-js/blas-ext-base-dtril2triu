...
```bash
npm install @stdlib/blas-ext-base-dtril2triu
```
...
#### dtril2triu( order, M, N, k, A, LDA, B, LDB )
...
dtril2triu( 'row-major', 2, 2, -1, A, 2, B, 2 );
// B => <Float64Array>[ 0.0, 3.0, 0.0, 0.0 ]
```
...
dtril2triu( 'row-major', 2, 2, 0, A1, 2, B1, 2 );
// B0 => <Float64Array>[ 0.0, 2.0, 4.0, 0.0, 5.0 ]
```

#### dtril2triu.ndarray( M, N, k, A, sa1, sa2, oa, B, sb1, sb2, ob )

Reflects the lower triangular part of a double-precision floating-point matrix `A` into the upper triangular part of another matrix `B` using alternative indexing semantics.
...
dtril2triu.ndarray( 2, 2, 0, A, 2, 1, 0, B, 2, 1, 2 );
// B => <Float64Array>[ 0.0, 0.0, 1.0, 3.0, 0.0, 4.0 ]
```
...
dtril2triu( order, shape[ 0 ], shape[ 1 ], 0, A, strides[ 0 ], B, stridesB[ 0 ] );
console.log( ndarray2array( B, shapeB, stridesB, 0, order ) );
```
...
```c
#include "stdlib/blas/ext/base/dtril2triu.h"
```

#### stdlib_strided_dtril2triu( layout, M, N, k, \*A, LDA, \*B, LDB )
...
stdlib_strided_dtril2triu( CblasRowMajor, 2, 2, 0, A, 2, B, 2 );
```
...
stdlib_strided_dtril2triu_ndarray( 2, 2, 0, A, 2, 1, 0, B, 2, 1, 0 );
```
...
int main( void ) {
    ...
    // Reflect the lower triangular part of `A` into the upper triangular part of `B`:
    stdlib_strided_dtril2triu( CblasRowMajor, M, N, 0, A, N, B, N );
    ...
    // Reflect the lower triangular part of `A` (below the first sub-diagonal) into `B` using alternative indexing semantics:
    stdlib_strided_dtril2triu_ndarray( M, N, -1, A, N, 1, 0, B, N, 1, 0 );
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-dtril2triu.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-dtril2triu

[test-image]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-dtril2triu/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-dtril2triu?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dtril2triu.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dtril2triu/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dtril2triu/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-dtril2triu/main/LICENSE
